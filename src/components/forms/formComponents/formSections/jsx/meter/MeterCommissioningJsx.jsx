				...
				<div className="ast">
					...
					<div className="row-2 ast-row">
						<FormikControl
							...
							name={`astData[${astCat}][${astCatIndex}].trnData.meterCommissioning.voltageReading`}
							placeholder="Voltage Reading"
						/>
						<FormikControl
							control="input"
							type="text"
							name={`astData[${astCat}][${astCatIndex}].trnData.meterCommissioning.meterReading`}
							label="meter reading"
					...
					<div className="row-4 ast-row">
						<FormikControl
							...
							name={`astData[${astCat}][${astCatIndex}].trnData.meterCommissioning.confirmInstallationData`}
