				...
				<div className="ast">
					<div className="row-1 ast-row read-only-row">
						<div className="data">
							...
							<p>
								Asset ({ast.astData.astCartegory}) No -{" "}
								<span>{ast?.astData.astNo}</span>
							</p>
							<p>
						...
						<div className="data">
							...
							<p>
								...
								<span>
									{
										trn.astData[astCat][astCatIndex][`${astCat}Installation`].linkedMeter
											.isLinkedToMeter
									}
								</span>
							</p>
					...
					<div className="row-2 ast-row">
						<FormikControl
							...
							name={`astData[${astCat}][${astCatIndex}].trnData.cbCommissioning.cbSizeVerified`}
						...
						<FormikControl
							...
							name={`astData[${astCat}][${astCatIndex}].trnData.cbCommissioning.cbMeterLinkVerified`}
